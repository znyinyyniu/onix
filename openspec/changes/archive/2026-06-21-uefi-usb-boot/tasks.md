...
- [x] 9.1 从 USB 3.0 在 i5-5200U 上启动：内核进入用户态，Minix 根位于 P2
- [x] 9.2 验证可写根：创建或覆盖文件（如 `/hello.txt`）并读回
- [x] 9.3 从 USB 根运行至少一个内置 `/bin` 应用程序
- [x] 9.4 确认未设置 `ONIX_USB_BOOT` 时，传统 ISO / `master.img` 启动仍正常
